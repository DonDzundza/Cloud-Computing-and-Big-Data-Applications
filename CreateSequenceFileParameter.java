...
public class CreateSequenceFileParameter extends Configured implements Tool {
  ...
  public int run(String[] args) throws Exception {
    ...
    Boolean bool = conf.getBoolean("mapred.output.compress", false);
    ...
    FileOutputFormat.setOutputCompressorClass(job, (Class<? extends CompressionCodec>) SnappyCodec.class);
